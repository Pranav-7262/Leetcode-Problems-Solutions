<h2> 572 36
2520. Count the Digits That Divide a Number</h2><hr><div><p>Given an integer <code>num</code>, return <em>the number of digits in <code>num</code> that divide </em><code>num</code>.</p>
