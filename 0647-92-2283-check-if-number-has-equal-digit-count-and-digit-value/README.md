<h2> 647 92
2283. Check if Number Has Equal Digit Count and Digit Value</h2><hr><div><p>You are given a <strong>0-indexed</strong> string <code>num</code> of length <code>n</code> consisting of digits.</p>
