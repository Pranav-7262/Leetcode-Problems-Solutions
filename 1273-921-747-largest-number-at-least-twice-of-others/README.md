<h2> 1273 921
747. Largest Number At Least Twice of Others</h2><hr><div><p>You are given an integer array <code>nums</code> where the largest integer is <strong>unique</strong>.</p>
