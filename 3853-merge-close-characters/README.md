<h2><a href="https://leetcode.com/problems/merge-close-characters/">4013. Merge Close Characters</a></h2><h3>Medium</h3><hr><p>You are given a string <code>s</code> consisting of lowercase English letters and an integer <code>k</code>.</p>
