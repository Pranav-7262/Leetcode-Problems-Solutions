<h2> 769 107
1670. Design Front Middle Back Queue</h2><hr><div><p>Design a queue that supports <code>push</code> and <code>pop</code> operations in the front, middle, and back.</p>
