<h2> 490 12
3264. Final Array State After K Multiplication Operations I</h2><hr><div><p>You are given an integer array <code>nums</code>, an integer <code>k</code>, and an integer <code>multiplier</code>.</p>
