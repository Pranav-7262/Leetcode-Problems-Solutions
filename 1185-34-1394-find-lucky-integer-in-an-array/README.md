<h2> 1185 34
1394. Find Lucky Integer in an Array</h2><hr><div><p>Given an array of integers <code>arr</code>, a <strong>lucky integer</strong> is an integer that has a frequency in the array equal to its value.</p>
